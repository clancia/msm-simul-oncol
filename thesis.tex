...
For example, if group A consists of thirty of the headache sufferers who
all took ibuprofen, we would ideally compare the quantity
...
a causal relstionship between \(X\) and \(Y\) as well as a causal
...
Link back to the headache example and explain why the baselines will be
variables like age and sex and then switch to the canonical example of
AZT, CDF and mortality among HIV patients.
...
Link back each assumption to previous discussion for why it is
important.
...
\subsection{related simulation models}\label{related-simulation-models}
